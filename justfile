...
# A module subscribing to block or chain-log events also needs an engine.toml
# declaring each subscribed chain (see the README); the example module has no
# subscriptions, so this recipe runs without one.
